const mockData = [
  ...
  /**
   * Populates the #products element with custom elements ('product-item')
   * of all products in the mock data.
   */
  ...
  customElements.define('product-item', class Item extends HTMLElement {
    /**
     * Creates a new instance of the 'product-item' custom element.
     * It constructs the shadow DOM by cloning the content of the
     * '#item' template and appending it to the element.
     */
    constructor() {
      super()
